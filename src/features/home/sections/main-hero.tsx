			...
			<div className="relative z-30 flex h-full w-full flex-col items-center justify-center px-2 pt-16 pb-24 md:pb-0">
				...
				<div className="bottom-reveal mt-8 text-center md:mt-4">
					...
					<div className="flex flex-wrap justify-center gap-4 pt-6 md:pt-8">
						<Link
							className="inline-flex h-12 items-center justify-center rounded-lg bg-blue-600 px-8 font-semibold text-sm text-white transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-blue-700"
							href="/contact"
						>
							{t("requestQuote")}
							<Image
