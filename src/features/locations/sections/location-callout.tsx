...
export function LocationCallout({ emirate }: LocationCalloutProps) {
	const t = useTranslations("locations.common.callout");

	return (
		<section className="py-12 text-white">
			<div className="container mx-auto max-w-7xl px-6 md:px-12">
				<div className="flex flex-col items-center justify-between gap-6 rounded-lg border border-white/20 bg-blue-600 p-8 md:flex-row">
					<div>
