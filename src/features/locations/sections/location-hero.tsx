...
export function LocationHero({ data }: LocationHeroProps) {
	return (
		<section className="relative flex flex-col justify-center overflow-hidden bg-slate-50/60 px-6 pt-40 pb-12 lg:px-16">
			{/* Background SVG Watermark Accent */}
			...
			<div className="container relative z-10 mx-auto max-w-7xl text-center">
				<div className="flex flex-col items-center space-y-6">
					<motion.h1
						...
						className="max-w-5xl font-black text-4xl text-blue-600 uppercase leading-[1.1] tracking-tighter sm:text-5xl md:text-6xl lg:text-[5rem]"
