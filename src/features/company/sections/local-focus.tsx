						...
						{EMIRATES.map((emirate, index) => {
							...
							return (
								...
								>
									...
									<div
										className={`absolute w-max whitespace-nowrap rounded-lg border border-slate-200 bg-white px-4 py-2 shadow-md transition duration-300 hover:-translate-y-1 hover:border-blue-400/50 hover:shadow-xl ${
