	...
	return (
		...
		>
			...
			>
				...
				<div className="flex h-12 w-12 items-center justify-center rounded-full bg-transparent transition-transform duration-300 group-hover:scale-110 md:bg-white/20">
